...
const BACKEND_ROUTE = "http://localhost:8000/api/routes/chat/";

const ChatInterface = () => {
  const [messages, setMessages] = useState([
    {
      text: "Hi, I'm here to help with any questions about College Admissions and Scholarships! What would you like to know?",
      type: 'bot'
    }
  ]);
