...
from flare_ai_rag.api import ChatRouter, FastSearchAPI
...
def create_app() -> FastAPI:
    ...
    # Create a Fast Search API
    fast_search_api = FastSearchAPI(
        api_router=api_router,
        retriever=gemini_retriever,
        responder=gemini_responder,
    )
    logger.info("Fast Search API has been set up.")
    
    # Create FastAPI App
    app = FastAPI(
        title="Flare AI Fast Search RAG System",
        description="Fast Search RAG System for Flare AI hackathon",
    )
    # Include the API router with the chat and fast-search endpoints
