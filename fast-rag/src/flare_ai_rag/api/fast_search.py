...
from flare_ai_rag.api.routes.fast_search import router, set_components

class FastSearchAPI:
    """
    API handler for Fast Search RAG functionality.
    
    This class initializes the Fast Search RAG API routes and sets up
    ...
    def __init__(
        ...
        """
        Initialize the Fast Search API.
