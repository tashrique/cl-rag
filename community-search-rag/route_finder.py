...
print_separator()
print(f"🔍 Scanning {base_url} for working Community Search RAG endpoints")
print_separator()
...
print_separator()
print("Testing community search query endpoints with POST:")
query_paths = [
    ...
    "/api/query",
    "/api/community-search/query",
    "/api/routes/query",
    "/api/routes/community-search/query",
    # Chat API variations
    "/api/chat/query",
    "/api/chat/community-search/query",
    "/api/routes/chat/query",
    "/api/routes/chat/community-search/query",
