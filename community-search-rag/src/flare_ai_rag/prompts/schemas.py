...
class ScholarshipEligibilityResponse(TypedDict):
    """
    Type definition for scholarship eligibility response.

    Defines the required fields for a scholarship eligibility assessment.

    Attributes:
        eligible (bool): Whether the student is eligible for the scholarship
        explanation (str): Brief explanation of the eligibility decision
    """
